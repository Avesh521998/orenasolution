...
class VerifiedInterviewer extends StatefulWidget {
  @override
  _VerifiedInterviewerState createState() => _VerifiedInterviewerState();
}

class _VerifiedInterviewerState extends State<VerifiedInterviewer> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Interviewer Details'),
      ),
      body: StreamBuilder(
            ...
            return GestureDetector(
              ...
              child: Card(
               /* shape: StadiumBorder(			//Card with stadium border
                ...
                subtitle: Text(list[index]['Email'],style: TextStyle(fontSize: 15,)),
              ),),
